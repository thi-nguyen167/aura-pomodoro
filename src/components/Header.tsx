  ...
  return (
    <header className="relative z-10 pt-container px-container pb-0 flex shrink-0">
      <div className="flex justify-between items-center w-full">
        <h1 className="font-mono text-2xl md:text-3xl lg:text-5xl font-extrabold text-primary text-shadow-glow">
          Aura <br />{" "}
          <span className="font-sans text-lg md:text-xl lg:text-2xl uppercase tracking-[0.2em] text-primary-container">
            Pomodoro
          </span>
        </h1>
